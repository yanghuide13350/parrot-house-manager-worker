...
export const WRITE_ACTIONS = new Set(['parrots.create','introductions.create','introductions.markForSale','parrots.createFromClutch','parrots.update','parrots.delete','parrots.restore','parrots.setBreeder','parrots.unsetBreeder','parrots.setFeedingPlan','feedingPlans.create','feedingPlans.update','feedingPlans.delete','feedingPlans.setEnabled','supplies.create','supplies.delete','breeding.pair','breeding.cancel','hatching.create','hatching.updateProgress','hatching.complete','hatching.delete','sales.create','sales.delete','sales.return','sales.updateFollowUp','shares.create','shares.revoke'])
